...
const createRestaurantHTML = (restaurant) => {
    ...
    const restaurantHTML =
        `<li class="restaurant-list-item">
            <button data-restaurant-id="${restaurant.id}" tabindex="0" class="favourite-toggle" type="button" aria-label="Add to favourites" aria-pressed="${restaurant.is_favorite}" title="Save this restaurant for later">
...
const toggleButtonState = () => {
    let cardContainer = document.getElementById('restaurants-list');
    cardContainer.addEventListener('click', updateButtonState, false);
}
...
const updateButtonState = (e) => {
    if (e.target.tagName === 'BUTTON') {
        ...
        //post data about restaurant to database
